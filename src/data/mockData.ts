...
export const actors: Actor[] = [
  {
    ...
    photo: christianBalePhoto, awardsCount: 8,
    primaryRole: "Actor", placeOfBirth: "Haverfordwest, Wales, UK", height: "6'0\" (183 cm)", activeYears: "1986–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/christianbale" }],
    ...
    awards: [
      { name: "Academy Award", category: "Best Supporting Actor", year: 2011, result: "Won" },
      { name: "Golden Globe", category: "Best Actor - Drama", year: 2019, result: "Nominated" },
      { name: "SAG Award", category: "Best Actor", year: 2011, result: "Won" },
    ],
  },
  {
    ...
    photo: puneethRajkumarPhoto, awardsCount: 10,
    primaryRole: "Actor", placeOfBirth: "Chennai, Tamil Nadu, India", height: "5'7\" (170 cm)", activeYears: "1985–2021",
    socialLinks: [{ platform: "Twitter", url: "https://twitter.com/PunesRajkumar" }],
    ...
    awards: [
      { name: "Karnataka State Film Award", category: "Best Actor", year: 2017, result: "Won" },
      { name: "Filmfare South", category: "Best Actor", year: 2017, result: "Won" },
      { name: "National Film Award", category: "Best Child Actor", year: 1985, result: "Won" },
    ],
  },
  {
    ...
    photo: kanganaRanautPhoto, awardsCount: 11,
    primaryRole: "Actor / Director", placeOfBirth: "Bhambla, Himachal Pradesh, India", height: "5'5\" (165 cm)", activeYears: "2006–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/kanganaranaut" }, { platform: "Twitter", url: "https://twitter.com/KanganaTeam" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Actress", year: 2015, result: "Won" },
      { name: "National Film Award", category: "Best Actress", year: 2016, result: "Won" },
      { name: "Filmfare Award", category: "Best Actress", year: 2015, result: "Won" },
      { name: "Padma Shri", category: "Distinguished Service in Arts", year: 2020, result: "Won" },
    ],
  },
  {
    ...
    photo: yashPhoto, awardsCount: 7,
    primaryRole: "Actor", placeOfBirth: "Bhuvanahalli, Karnataka, India", height: "5'9\" (175 cm)", activeYears: "2007–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/taborockingstar" }, { platform: "Twitter", url: "https://twitter.com/TheNameIsYash" }],
    ...
    awards: [
      { name: "Filmfare South", category: "Best Actor", year: 2019, result: "Won" },
      { name: "SIIMA Award", category: "Best Actor", year: 2022, result: "Won" },
      { name: "Karnataka State Film Award", category: "Best Actor", year: 2022, result: "Nominated" },
    ],
  },
  {
    ...
    photo: cateBlanchettPhoto, awardsCount: 14,
    primaryRole: "Actor / Producer", placeOfBirth: "Ivanhoe, Melbourne, Australia", height: "5'8\" (174 cm)", activeYears: "1992–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/caborat" }],
    ...
    awards: [
      { name: "Academy Award", category: "Best Actress", year: 2014, result: "Won" },
      { name: "Academy Award", category: "Best Supporting Actress", year: 2005, result: "Won" },
      { name: "Academy Award", category: "Best Actress", year: 2023, result: "Nominated" },
      { name: "BAFTA", category: "Best Actress", year: 2023, result: "Won" },
    ],
  },
  {
    ...
    photo: priyankaChopraPhoto, awardsCount: 12,
    primaryRole: "Actor / Producer", placeOfBirth: "Jamshedpur, Jharkhand, India", height: "5'5\" (165 cm)", activeYears: "2002–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/priyankachopra" }, { platform: "Twitter", url: "https://twitter.com/praboriyankachopra" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Actress", year: 2008, result: "Won" },
      { name: "Filmfare Award", category: "Best Actress", year: 2009, result: "Won" },
      { name: "Padma Shri", category: "Distinguished Service in Arts", year: 2016, result: "Won" },
    ],
  },
  {
    ...
    photo: deepikaPadukonePhoto, awardsCount: 10,
    primaryRole: "Actor / Producer", placeOfBirth: "Copenhagen, Denmark", height: "5'9\" (174 cm)", activeYears: "2006–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/deepikapadukone" }, { platform: "Twitter", url: "https://twitter.com/deepikapadukone" }],
    ...
    awards: [
      { name: "Filmfare Award", category: "Best Actress", year: 2016, result: "Won" },
      { name: "Filmfare Award", category: "Best Actress", year: 2019, result: "Won" },
      { name: "IIFA Award", category: "Best Actress", year: 2016, result: "Won" },
      { name: "Time 100", category: "Most Influential People", year: 2018, result: "Won" },
    ],
  },
  {
    ...
    photo: rishabShettyPhoto, awardsCount: 8,
    primaryRole: "Actor / Director", placeOfBirth: "Kervashe, Karnataka, India", height: "5'6\" (168 cm)", activeYears: "2012–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/rishabshettyofficial" }, { platform: "Twitter", url: "https://twitter.com/saborishabshetty" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Feature Film", year: 2023, result: "Won" },
      { name: "Karnataka State Award", category: "Best Director", year: 2023, result: "Won" },
      { name: "Filmfare South", category: "Best Actor", year: 2023, result: "Won" },
    ],
  },
  {
    ...
    photo: srkPhoto, awardsCount: 20,
    primaryRole: "Actor / Producer", placeOfBirth: "New Delhi, India", height: "5'8\" (173 cm)", activeYears: "1988–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/iamsrk" }, { platform: "Twitter", url: "https://twitter.com/iamsrk" }],
    ...
    awards: [
      { name: "Filmfare Award", category: "Best Actor", year: 1998, result: "Won" },
      { name: "Filmfare Award", category: "Best Actor", year: 2001, result: "Won" },
      { name: "Padma Shri", category: "Distinguished Service in Arts", year: 2005, result: "Won" },
      { name: "Ordre des Arts et des Lettres", category: "Chevalier", year: 2014, result: "Won" },
    ],
  },
  {
    ...
    photo: manojBajpayeePhoto, awardsCount: 12,
    primaryRole: "Actor", placeOfBirth: "Belwa, Bihar, India", height: "5'10\" (178 cm)", activeYears: "1994–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/bajaborpayee.manoj" }, { platform: "Twitter", url: "https://twitter.com/BajaborpayeeManoj" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Actor", year: 1998, result: "Won" },
      { name: "National Film Award", category: "Best Actor", year: 2022, result: "Won" },
      { name: "Padma Shri", category: "Distinguished Service in Arts", year: 2019, result: "Won" },
      { name: "Filmfare Award", category: "Best Actor (Critics)", year: 2013, result: "Won" },
    ],
  },
  {
    ...
    photo: vidyaBalanPhoto, awardsCount: 9,
    primaryRole: "Actor", placeOfBirth: "Palakkad, Kerala, India", height: "5'4\" (163 cm)", activeYears: "2003–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/baaborlanvidya" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Actress", year: 2012, result: "Won" },
      { name: "Padma Shri", category: "Distinguished Service in Arts", year: 2014, result: "Won" },
      { name: "Filmfare Award", category: "Best Actress", year: 2012, result: "Won" },
    ],
  },
  {
    ...
    photo: emmaWatsonPhoto, awardsCount: 8,
    primaryRole: "Actor / Activist", placeOfBirth: "Paris, France", height: "5'5\" (165 cm)", activeYears: "2001–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/emmawatson" }, { platform: "Twitter", url: "https://twitter.com/EmWatson" }],
    ...
    awards: [
      { name: "MTV Movie Award", category: "Best Female Performance", year: 2011, result: "Won" },
      { name: "British Artist of the Year", category: "Excellence in Arts", year: 2014, result: "Won" },
      { name: "Teen Choice Award", category: "Best Actress", year: 2011, result: "Won" },
    ],
  },
  {
    ...
    photo: leonardoDiCaprioPhoto, awardsCount: 15,
    primaryRole: "Actor / Producer", placeOfBirth: "Los Angeles, California, USA", height: "6'0\" (183 cm)", activeYears: "1989–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/leonardodicaprio" }, { platform: "Twitter", url: "https://twitter.com/LeoDiCaprio" }],
    ...
    awards: [
      { name: "Academy Award", category: "Best Actor", year: 2016, result: "Won" },
      { name: "Golden Globe", category: "Best Actor - Drama", year: 2016, result: "Won" },
      { name: "Academy Award", category: "Best Actor", year: 2014, result: "Nominated" },
      { name: "SAG Award", category: "Best Actor", year: 2016, result: "Won" },
    ],
  },
  {
    ...
    photo: aliaBhattPhoto, awardsCount: 9,
    primaryRole: "Actor / Producer", placeOfBirth: "Mumbai, Maharashtra, India", height: "5'3\" (161 cm)", activeYears: "2012–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/alaboriaabhatt" }, { platform: "Twitter", url: "https://twitter.com/aliaa08" }],
    ...
    awards: [
      { name: "Filmfare Award", category: "Best Actress", year: 2019, result: "Won" },
      { name: "Filmfare Award", category: "Best Actress", year: 2022, result: "Won" },
      { name: "IIFA Award", category: "Best Actress", year: 2019, result: "Won" },
      { name: "National Film Award", category: "Special Jury", year: 2023, result: "Nominated" },
    ],
  },
  {
    ...
    photo: ranbirKapoorPhoto, awardsCount: 8,
    primaryRole: "Actor", placeOfBirth: "Mumbai, Maharashtra, India", height: "6'0\" (183 cm)", activeYears: "2007–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/ranborbirkapoorofficial" }],
    ...
    awards: [
      { name: "Filmfare Award", category: "Best Actor", year: 2013, result: "Won" },
      { name: "Filmfare Award", category: "Best Actor", year: 2019, result: "Won" },
      { name: "IIFA Award", category: "Best Actor", year: 2013, result: "Won" },
      { name: "Filmfare Award", category: "Best Actor", year: 2024, result: "Nominated" },
    ],
  },
  {
    ...
    photo: amitabhBachchanPhoto, awardsCount: 25,
    primaryRole: "Actor / Producer", placeOfBirth: "Allahabad, Uttar Pradesh, India", height: "6'1\" (188 cm)", activeYears: "1969–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/amitabhbachchan" }, { platform: "Twitter", url: "https://twitter.com/SrBachchan" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Actor", year: 1991, result: "Won" },
      { name: "National Film Award", category: "Best Actor", year: 2005, result: "Won" },
      { name: "Padma Vibhushan", category: "Contribution to Cinema", year: 2015, result: "Won" },
      { name: "Dadasaheb Phalke Award", category: "Lifetime Achievement", year: 2019, result: "Won" },
      { name: "National Film Award", category: "Best Actor", year: 2016, result: "Nominated" },
    ],
  },
  {
    ...
    photo: tomHanksPhoto, awardsCount: 18,
    primaryRole: "Actor / Producer", placeOfBirth: "Concord, California, USA", height: "6'0\" (183 cm)", activeYears: "1980–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/tomhanks" }, { platform: "Twitter", url: "https://twitter.com/tomhanks" }],
    ...
    awards: [
      { name: "Academy Award", category: "Best Actor", year: 1994, result: "Won" },
      { name: "Academy Award", category: "Best Actor", year: 1995, result: "Won" },
      { name: "Presidential Medal of Freedom", category: "Lifetime Achievement", year: 2016, result: "Won" },
      { name: "Kennedy Center Honors", category: "Lifetime Achievement", year: 2014, result: "Won" },
    ],
  },
  {
    ...
    photo: merylStreepPhoto, awardsCount: 22,
    primaryRole: "Actor", placeOfBirth: "Summit, New Jersey, USA", height: "5'6\" (168 cm)", activeYears: "1975–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/merylstreep" }],
    ...
    awards: [
      { name: "Academy Award", category: "Best Actress", year: 2012, result: "Won" },
      { name: "Academy Award", category: "Best Actress", year: 1983, result: "Won" },
      { name: "Academy Award", category: "Best Supporting Actress", year: 1980, result: "Won" },
      { name: "Academy Award", category: "Best Actress", year: 2018, result: "Nominated" },
      { name: "Presidential Medal of Freedom", category: "Lifetime Achievement", year: 2014, result: "Won" },
    ],
  },
  {
    ...
    photo: akshayKumarPhoto, awardsCount: 13,
    primaryRole: "Actor / Producer", placeOfBirth: "Amritsar, Punjab, India", height: "5'11\" (182 cm)", activeYears: "1991–Present",
    socialLinks: [{ platform: "Instagram", url: "https://instagram.com/akshaykumar" }, { platform: "Twitter", url: "https://twitter.com/akshaykumar" }],
    ...
    awards: [
      { name: "National Film Award", category: "Best Actor", year: 2017, result: "Won" },
      { name: "Padma Shri", category: "Distinguished Service in Arts", year: 2009, result: "Won" },
      { name: "Filmfare Award", category: "Best Actor", year: 2017, result: "Won" },
      { name: "Filmfare Award", category: "Best Actor", year: 2020, result: "Nominated" },
    ],
  },
];
