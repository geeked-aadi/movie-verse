...
export const recommendedMovies: Movie[] = [
  ...
  {
    id: 211, title: "Sholay", year: 1975, genre: ["Action", "Adventure", "Comedy"], rating: 8.1,
    director: "Ramesh Sippy", duration: "3h 24min", language: "Hindi",
    synopsis: "Two criminals are hired by a retired police officer to capture a ruthless bandit terrorizing a village.",
    poster: "https://m.media-amazon.com/images/M/MV5BMjE0NTUyNjk0M15BMl5BanBnXkFtZTYwNDg0NzY3._V1_.jpg", heroImage: "",
    budget: "₹3 Cr", boxOffice: "₹35 Cr",
    cast: [{ name: "Amitabh Bachchan", role: "Jai" }, { name: "Dharmendra", role: "Veeru" }],
    awards: ["Filmfare Award - Best Film", "Filmfare Award - Best Director"],
    trailerUrl: "https://www.youtube.com/embed/HMSYAclrIUU",
  },
  {
